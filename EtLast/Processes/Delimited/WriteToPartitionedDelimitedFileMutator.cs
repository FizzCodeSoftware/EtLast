...
public sealed class WriteToPartitionedDelimitedFileMutator : AbstractMutator, IRowSink
{
...
public static class WriteToPartitionedDelimitedFileMutatorFluent
{
    /// <summary>
    /// Write rows to a delimited stream.
    /// </summary>
    public static IFluentSequenceMutatorBuilder WriteToPartitionedDelimitedFile(this IFluentSequenceMutatorBuilder builder, WriteToPartitionedDelimitedFileMutator mutator)
    {
