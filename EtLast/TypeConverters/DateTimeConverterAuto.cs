...
public static class DateTimeConverterAutoFluent
{
    ...
    public static TextReaderColumn AsDateTimeAuto(this TextReaderColumn column, IFormatProvider formatProvider, DateTimeStyles dateTimeStyles = DateTimeStyles.AllowWhiteSpaces) => column.WithTypeConverter(new DateTimeConverterAuto(formatProvider, dateTimeStyles));
    public static TextReaderColumn AsDateTimeAuto(this TextReaderColumn column, string format, IFormatProvider formatProvider, DateTimeStyles dateTimeStyles = DateTimeStyles.AllowWhiteSpaces) => column.WithTypeConverter(new DateTimeConverterAuto(format, formatProvider, dateTimeStyles));
