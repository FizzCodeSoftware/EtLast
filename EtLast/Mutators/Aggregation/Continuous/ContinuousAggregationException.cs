namespace FizzCode.EtLast
{
    ...
    {
        public ContinuousAggregationException(ContinuousAggregationMutator mutator, IContinuousAggregationOperation operation, IEtlRow row, Exception innerException)
