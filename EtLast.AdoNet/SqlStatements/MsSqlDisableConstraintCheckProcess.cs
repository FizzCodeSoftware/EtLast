namespace FizzCode.EtLast.AdoNet
{
    ...
    public class MsSqlDisableConstraintCheckProcess : AbstractSqlStatementsProcess
    {
        ...
        public MsSqlDisableConstraintCheckProcess(IEtlContext context, string name = null)
            : base(context, name)
        {
        }
        ...
        protected override void RunCommand(IDbCommand command, int statementIndex, Stopwatch startedOn)
        {
            ...
            Context.Log(LogSeverity.Debug, this, "disable constraint check on {ConnectionStringKey}/{TableName} with SQL statement {SqlStatement}, timeout: {Timeout} sec, transaction: {Transaction}", ConnectionString.Name,
            ...
            try
            {
                ...
                Context.Log(LogSeverity.Debug, this, "constraint check on {ConnectionStringKey}/{TableName} is disabled, transaction: {Transaction}", ConnectionString.Name,
        ...
        protected override void LogSucceeded(int lastSucceededIndex)
        {
            ...
            Context.Log(LogSeverity.Information, this, "constraint check successfully disabled on {TableCount} tables on {ConnectionStringKey} in {Elapsed}, transaction: {Transaction}", lastSucceededIndex + 1,
