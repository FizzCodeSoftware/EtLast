...
#pragma warning restore CA1001 // Types that own disposable fields should be disposable
    {
        ...
        private void WriteToSql(bool shutdown)
        {
            ...
            try
            {
                ...
                Process.Context.Log(severity, Process, this, "{TotalRowCount} records written to {ConnectionStringName}/{TableName}, transaction: {Transaction}, average speed is {AvgSpeed} sec/Mrow), last batch time: {BatchElapsed}", _rowsWritten,
        ...
        public override void Prepare()
        {
            ...
            if (ConnectionString.KnownProvider != KnownProvider.SqlServer)
                throw new InvalidOperationParameterException(this, nameof(ConnectionString), ConnectionString.ProviderName, "provider name must be System.Data.SqlClient");
