namespace FizzCode.EtLast.AdoNet
{
    ...
    public class AdoNetReaderConnectionScope
    {
        ...
        public void GetConnection(ConnectionStringWithProvider connectionString, AbstractAdoNetDbReader process, out DatabaseConnection connection, out IDbTransaction transaction)
        {
