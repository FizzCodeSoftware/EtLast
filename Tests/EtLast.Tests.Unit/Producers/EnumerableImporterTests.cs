    ...
    public class EnumerableImporterTests
    {
        ...
        public void FullCopy()
        {
            ...
            Assert.That.ExactMatch(result, new List<Dictionary<string, object>>() {
                ...
                new Dictionary<string, object>() { ["id"] = 5, ["name"] = "A", ["age"] = 11, ["height"] = 140, ["countryId"] = 3, ["birthDate"] = new DateTime(2013, 5, 15, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2018, 1, 1, 0, 0, 0, 0) },
        ...
        public void CopyOnlySpecifiedColumnsOff()
        {
            ...
            Assert.AreEqual(7, result.MutatedRows.Count);
            Assert.That.ExactMatch(result, new List<Dictionary<string, object>>() {
                new Dictionary<string, object>() { ["ID"] = "0", ["age"] = 17L, ["name"] = "A", ["height"] = 160, ["eyeColor"] = "brown", ["countryId"] = 1, ["birthDate"] = new DateTime(2010, 12, 9, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2015, 12, 19, 12, 0, 1, 0) },
                new Dictionary<string, object>() { ["ID"] = "1", ["age"] = 8L, ["name"] = "B", ["height"] = 190, ["countryId"] = 1, ["birthDate"] = new DateTime(2011, 2, 1, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2015, 12, 19, 13, 2, 0, 0) },
                new Dictionary<string, object>() { ["ID"] = "2", ["age"] = 27L, ["name"] = "C", ["height"] = 170, ["eyeColor"] = "green", ["countryId"] = 2, ["birthDate"] = new DateTime(2014, 1, 21, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2015, 11, 21, 17, 11, 58, 0) },
                new Dictionary<string, object>() { ["ID"] = "3", ["age"] = 39L, ["name"] = "D", ["height"] = 160, ["eyeColor"] = "fake", ["countryId"] = 3, ["birthDate"] = "2018.07.11", ["lastChangedTime"] = new DateTime(2017, 8, 1, 4, 9, 1, 0) },
                new Dictionary<string, object>() { ["ID"] = "4", ["age"] = -3L, ["name"] = "E", ["height"] = 160, ["countryId"] = 1, ["lastChangedTime"] = new DateTime(2019, 1, 1, 23, 59, 59, 0) },
                new Dictionary<string, object>() { ["ID"] = "5", ["age"] = 11L, ["name"] = "A", ["height"] = 140, ["countryId"] = 3, ["birthDate"] = new DateTime(2013, 5, 15, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2018, 1, 1, 0, 0, 0, 0) },
                new Dictionary<string, object>() { ["ID"] = "6", ["age"] = -1L, ["name"] = "fake", ["height"] = 140, ["countryId"] = 5, ["birthDate"] = new DateTime(2018, 1, 9, 0, 0, 0, 0) } });
            var exceptions = topic.Context.GetExceptions();
            Assert.AreEqual(0, exceptions.Count);
        }
        ...
        public void CopyOnlySpecifiedColumnsOn()
        {
            ...
            Assert.AreEqual(7, result.MutatedRows.Count);
            Assert.That.ExactMatch(result, new List<Dictionary<string, object>>() {
                new Dictionary<string, object>() { ["ID"] = "0", ["age"] = 17L },
                new Dictionary<string, object>() { ["ID"] = "1", ["age"] = 8L },
                new Dictionary<string, object>() { ["ID"] = "2", ["age"] = 27L },
                new Dictionary<string, object>() { ["ID"] = "3", ["age"] = 39L },
                new Dictionary<string, object>() { ["ID"] = "4", ["age"] = -3L },
                new Dictionary<string, object>() { ["ID"] = "5", ["age"] = 11L },
                new Dictionary<string, object>() { ["ID"] = "6", ["age"] = -1L } });
            var exceptions = topic.Context.GetExceptions();
            Assert.AreEqual(0, exceptions.Count);
        }
    }
