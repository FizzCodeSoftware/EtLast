    ...
    public class RemoveColumnMutatorTests
    {
        ...
        public void RemoveSome()
        {
            ...
            Assert.That.ExactMatch(result, new List<Dictionary<string, object>>() {
                ...
                new Dictionary<string, object>() { ["id"] = 3, ["age"] = 39, ["height"] = 160, ["countryId"] = 3, ["birthDate"] = "2018.07.11", ["lastChangedTime"] = new DateTime(2017, 8, 1, 4, 9, 1, 0) },
                new Dictionary<string, object>() { ["id"] = 4, ["age"] = -3, ["height"] = 160, ["countryId"] = 1, ["lastChangedTime"] = new DateTime(2019, 1, 1, 23, 59, 59, 0) },
                new Dictionary<string, object>() { ["id"] = 5, ["age"] = 11, ["height"] = 140, ["countryId"] = 3, ["birthDate"] = new DateTime(2013, 5, 15, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2018, 1, 1, 0, 0, 0, 0) },
