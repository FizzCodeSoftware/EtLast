    ...
    public class CustomMutatorTests
    {
        ...
        public void StageNotApplied()
        {
            ...
            Assert.That.ExactMatch(result.MutatedRows, new List<Dictionary<string, object>>() {
                ...
                new Dictionary<string, object>() { ["id"] = 3, ["name"] = "D", ["age"] = 39, ["height"] = 160, ["eyeColor"] = "fake", ["birthDate"] = "2018.07.11", ["lastChangedTime"] = new DateTime(2017, 8, 1, 4, 9, 1, 0), ["test"] = "test" } });
            var exceptions = topic.Context.GetExceptions();
            Assert.AreEqual(1, exceptions.Count);
            Assert.IsTrue(exceptions[0] is ProcessExecutionException);
        }
        ...
        public void IfDelegate()
        {
            ...
            Assert.That.ExactMatch(result.MutatedRows, new List<Dictionary<string, object>>() {
                ...
                new Dictionary<string, object>() { ["id"] = 5, ["name"] = "A", ["age"] = 11, ["height"] = 140, ["birthDate"] = new DateTime(2013, 5, 15, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2018, 1, 1, 0, 0, 0, 0), ["test"] = "test" },
