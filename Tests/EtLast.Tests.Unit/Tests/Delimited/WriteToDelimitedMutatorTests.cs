            ...
            builder = SequenceBuilder.Fluent
                .ReadDelimitedLines(new DelimitedLineReader()
                {
                    ...
                    Columns = new()
                    {
                        ["id"] = new TextReaderColumn().AsInt(),
                        ["name"] = new TextReaderColumn(),
                        ["age"] = new TextReaderColumn().AsInt(),
                        ["HeightInCm"] = new TextReaderColumn().AsInt(),
                        ["eyeColor"] = new TextReaderColumn(),
                        ["countryId"] = new TextReaderColumn().AsInt(),
                        ["birthDate"] = new TextReaderColumn().AsDateTime(),
                        ["lastChangedTime"] = new TextReaderColumn().AsDateTime(),
                    },
                    Header = DelimitedLineHeader.HasHeader,
                    Delimiter = ';',
                });
