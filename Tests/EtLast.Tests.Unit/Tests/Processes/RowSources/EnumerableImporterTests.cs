...
public class EnumerableImporterTests
{
    ...
    public void CopyOnlySpecifiedColumnsOff()
    {
        ...
        Assert.That.ExactMatch(result.MutatedRows, new List<CaseInsensitiveStringKeyDictionary<object>>() {
            ...
            new() { ["ID"] = 1, ["age"] = 8, ["name"] = "B", ["height"] = 190, ["eyeColor"] = null, ["countryId"] = 1, ["birthDate"] = new DateTime(2011, 2, 1, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2015, 12, 19, 13, 2, 0, 0) },
            ...
            new() { ["ID"] = 3, ["age"] = 39, ["name"] = "D", ["height"] = 160, ["eyeColor"] = "fake", ["countryId"] = null, ["birthDate"] = "2018.07.11", ["lastChangedTime"] = new DateTime(2017, 8, 1, 4, 9, 1, 0) },
            new() { ["ID"] = 4, ["age"] = -3, ["name"] = "E", ["height"] = 160, ["eyeColor"] = null, ["countryId"] = 1, ["birthDate"] = null, ["lastChangedTime"] = new DateTime(2019, 1, 1, 23, 59, 59, 0) },
            new() { ["ID"] = 5, ["age"] = 11, ["name"] = "A", ["height"] = 140, ["eyeColor"] = null, ["countryId"] = null, ["birthDate"] = new DateTime(2013, 5, 15, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2018, 1, 1, 0, 0, 0, 0) },
            new() { ["ID"] = 6, ["age"] = -1L, ["name"] = "fake", ["height"] = 140, ["eyeColor"] = null, ["countryId"] = 5, ["birthDate"] = new DateTime(2018, 1, 9, 0, 0, 0, 0), ["lastChangedTime"] = null } });
        Assert.AreEqual(0, result.Process.FlowState.Exceptions.Count);
    }
