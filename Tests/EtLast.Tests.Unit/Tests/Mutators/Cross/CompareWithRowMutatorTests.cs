...
public class CompareWithRowMutatorTests
{
    ...
    public void RemoveWhenMatchAndEquals()
    {
        ...
        var builder = SequenceBuilder.Fluent
            ...
            .CompareWithRow(new CompareWithRowMutator(context)
            {
                ...
                {
                    Process = TestData.PersonChanged(context),
    ...
    public void MatchButDifferentAction()
    {
        ...
        Assert.That.ExactMatch(result.MutatedRows, new List<CaseInsensitiveStringKeyDictionary<object>>() {
            ...
            new() { ["id"] = 1, ["name"] = "B", ["age"] = 8, ["height"] = 190, ["countryId"] = 1, ["birthDate"] = new DateTime(2011, 2, 1, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2015, 12, 19, 13, 2, 0, 0), ["compareResult"] = "match+unchanged" },
            ...
            new() { ["id"] = 3, ["name"] = "D", ["age"] = 39, ["height"] = 160, ["eyeColor"] = "fake", ["birthDate"] = "2018.07.11", ["lastChangedTime"] = new DateTime(2017, 8, 1, 4, 9, 1, 0), ["compareResult"] = "noMatch" },
            new() { ["id"] = 4, ["name"] = "E", ["age"] = -3, ["height"] = 160, ["countryId"] = 1, ["lastChangedTime"] = new DateTime(2019, 1, 1, 23, 59, 59, 0), ["compareResult"] = "match+diff" },
            new() { ["id"] = 5, ["name"] = "A", ["age"] = 11, ["height"] = 140, ["birthDate"] = new DateTime(2013, 5, 15, 0, 0, 0, 0), ["lastChangedTime"] = new DateTime(2018, 1, 1, 0, 0, 0, 0), ["compareResult"] = "match+diff" },
            new() { ["id"] = 6, ["name"] = "fake", ["height"] = 140, ["countryId"] = 5, ["birthDate"] = new DateTime(2018, 1, 9, 0, 0, 0, 0), ["compareResult"] = "match+diff" } });
        Assert.AreEqual(0, result.Process.FlowState.Exceptions.Count);
    }
}
