...
public class MergeOnlyInsertCountries : AbstractEtlTask
{
    ...
    public override void Execute(IFlow flow)
    {
        flow
            ...
            .ExecuteProcess(() => TestHelpers.CreateReadSqlTableAndAssertExactMatch(ConnectionString, nameof(MergeOnlyInsertCountries), new CaseInsensitiveStringKeyDictionary<object>() { ["Id"] = 1, ["Name"] = "Hungary", ["Abbreviation2"] = "HU", ["Abbreviation3"] = "HUN" },
